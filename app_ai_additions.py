# ================================================================
# DEPRECATED — app_ai_additions.py
# ================================================================
# Bu dosyadaki tüm route tanımları (api_ai_scrape, api_ai_analyze,
# api_crm_extract_contact vb.) artık doğrudan app.py içinde tam
# olarak implement edilmiştir.
#
# Bu dosya yalnızca referans amacıyla saklanmaktadır.
# Production build'e dahil ETMEYİN — confusion ve divergence riski taşır.
#
# Rapor: Nexa CRM Pro — Mühendislik Analiz Raporu — 21.05.2026
# Bölüm 5, F1: app_ai_additions.py Dead Code — ORTA öncelik
# ================================================================
